...
public class Main : MonoBehaviour 
{
    ...
    void Start () 
	{
        ...
        StartCoroutine(CallMethodEvery1ms());
    }

    private IEnumerator CallMethodEvery1ms()
    {
        while (true)
        {
            EntitiesWorkMethod();
            yield return new WaitForSeconds(0.003f); // Wait for 10 milliseconds
        }
    }

    private void EntitiesWorkMethod()
	{
